...
Write-Host
Write-Host SurfaceDuo-Drivers: components/ANYSOC/Support/Desktop/SUPPORT.DESKTOP.BASE/Settings/Version/phonereleaseversion.inf
Write-Host SurfaceDuo-Drivers: components/ANYSOC/Support/WCOS/SUPPORT.WCOS.BASE/Settings/Version/phonereleaseversion.inf
Write-Host
